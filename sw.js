const CACHE='hm-hybrid-v1';
const ASSETS=['./','index.html','styles.css','app.js','program-data.json','manifest.webmanifest','assets/high-mileage-logo.png','assets/icon-192.png','assets/icon-512.png'];
